...
if menu == "📖 REPOSITORIO CARRION":
    if 'ciclo_activo' not in st.session_state:
        ...
        # PANTALLA DE CURSOS (INYECCIÓN DE CONEXIÓN AQUÍ)
        ...
        # Lógica de archivos conectada a tu carpeta real
        ruta = os.path.join("BASE_DATOS", "01_CARRION", f"CICLO_{st.session_state['ciclo_activo']}")
        if os.path.exists(ruta):
            ...
            st.error(f"No se encontró la carpeta en: {ruta}")
