...
function LayoutConSidebar({ children, temaOscuro, setTemaOscuro }) {
  ...
  // ELIMINAMOS touchStart Y touchMove SEGÚN LO ACORDADO
  ...
  return (
    <div className={`min-h-screen ${bgPrincipal} flex flex-col md:flex-row relative overflow-hidden transition-colors duration-500`}>
      ...
      {/* TELÓN OSCURO PARA CERRAR PANELES EN MÓVIL */}
      ...
      {/* SIDEBAR ORIGINAL CON SU ESTRUCTURA INTACTA */}
      ...
      <div className="flex-1 flex flex-col min-w-0 h-screen overflow-hidden p-4 md:p-6 relative z-20">
        ...
        {/* CABECERA CON BOTONES ELEGANTES */}
        <header className="flex justify-between items-center mb-4 shrink-0">
          
          {/* BOTÓN MENÚ HAMBURGUESA (Solo visible en celular) */}
          ...
          <div className="flex items-center gap-3 ml-auto">
            {/* BOTÓN NOTAS (Visible en PC y Celular) */}
      ...
      {/* PANEL DEL BLOC DE NOTAS ORIGINAL */}
      ...
      <BrowserRouter>
        <LayoutConSidebar temaOscuro={temaOscuro} setTemaOscuro={setTemaOscuro}>
          <Routes>
            ...
            <Route path="/" element={<RutaProtegida><Dashboard temaOscuro={temaOscuro} setTemaOscuro={setTemaOscuro} /></RutaProtegida>} />
