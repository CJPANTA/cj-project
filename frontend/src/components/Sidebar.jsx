      ...
      <nav className="flex-1 space-y-4">
        ...
        {modoNavegacion === 'academia' && (
          <div className="space-y-2">
            ...
            {/* NUEVO ENLACE A HORARIO */}
            <Link to="/horario" onClick={alClickLink} className={`flex items-center gap-3 px-4 py-2.5 rounded-xl text-[11px] font-bold uppercase transition-all ${isActive('/horario') ? 'bg-[#22d3ee]/10 text-[#22d3ee]' : `${textoSecundario} ${hoverBg}`}`}>
